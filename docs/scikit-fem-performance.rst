...
.. meta::
   :description: Reproducible scikit-fem and skfem-native assembly performance comparison, including benchmark scope, environment, timing method, and recorded results.

``skfem-native`` moves reusable finite-element integration and sparse-scatter
...
skfem-native.  Setup and assembly phases are reported explicitly so that
one-time construction cost is not hidden inside repeated assembly timing.

The
`benchmark methodology and driver <https://github.com/kevin-tofu/skfem-native/tree/main/benchmarks/compare-with-skfem>`_,
`recorded environment and values <https://github.com/kevin-tofu/skfem-native/blob/main/benchmarks/compare-with-skfem/results/poisson-linux-x86_64.md>`_,
and
`scaling plot <https://github.com/kevin-tofu/skfem-native/blob/main/benchmarks/compare-with-skfem/results/poisson-linux-x86_64.png>`_
